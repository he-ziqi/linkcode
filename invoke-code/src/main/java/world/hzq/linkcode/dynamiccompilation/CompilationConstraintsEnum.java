...
public enum CompilationConstraintsEnum implements EnumType{
    ...
    COMPILE_NAME_PYTHON("file_name_python","Solution"),
    INVOKE_FILE_NAME_C("invoke_file_name_c","Solution-c"),
    INVOKE_FILE_NAME_PYTHON("invoke_file_name_python","Solution"),
    ...
    SUFFIX_FILE_SOURCE_PYTHON("suffix_source_python",".py"),
